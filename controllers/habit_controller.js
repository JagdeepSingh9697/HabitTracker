...
// this function creates a new habit if it doesn't exist
...
// this function is used to delete the habit
...
// this function will edit the habit title or habit desc
module.exports.editHabit = async function(req, res) {
    try {
        ...
        req.flash('success', 'Habit has been Updated Successfully');
        return res.redirect('/');
